...
#define TFT_LED_PIN                    GPIO_NUM_13 // Backlight control
#define TFT_CLK_PIN                    GPIO_NUM_12 // SPI Clock
#define TFT_MOSI_PIN                   GPIO_NUM_11 // SPI MOSI (Master Out Slave In)
#define TFT_CS_PIN                     GPIO_NUM_10 // Chip Select
#define TFT_RST_PIN                    GPIO_NUM_14 // Reset pin
#define TFT_DC_PIN                     GPIO_NUM_9  // Data/Command select
